...
excerpt: Alchemy is an embeddable Infrastructure-as-Code library written in pure TypeScript that runs anywhere JavaScript runs. Learn how it differs from traditional IaC tools.
date: 2025-07-01
---
